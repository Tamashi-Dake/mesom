  ...
  return (
    <div className="flex items-center justify-start">
      {onClick ? (
        <Button
          onClick={onClick}
          className="flex cursor-pointer items-center justify-start gap-4 rounded-2xl p-2"
        >
          {icon}
        ...
        <NavLink
          ...
          className={twMerge(
            "flex cursor-pointer items-center justify-start gap-4 rounded-2xl p-2 hover:bg-slate-400 hover:bg-opacity-10",
